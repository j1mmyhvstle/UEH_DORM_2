...
namespace ChuongTrinhQuanLyKyTuXa_Version3
{
    public partial class UpdateDeleteStudent : Form
    {
        ...
        {
            query = "SELECT * FROM Student WHERE mobile =" + txtMobile.Text + "";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            query = "update Student set name= '" + name + "', fname= '" + fname + "', mname= '" + mname + "', email= '" + email + "', paddress= '" + paddress + "', college= '" + college + "', idproof='" + idproof + "', roomNo= " + roomNo + ",living = '" + livingStatus + "' where mobile = " + mobile + " update rooms set Booked  = '" + livingStatus + "' where roomNo = " + roomNo + "";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                query = "DELETE FROM Student WHERE mobile = " + txtMobile.Text + "";
